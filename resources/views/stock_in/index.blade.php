    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
            <h2 class="text-2xl font-bold font-display text-slate-900 dark:text-white flex items-center gap-2.5">
                <i class="fas fa-truck-loading text-cyan-600 dark:text-cyan-400"></i> Stock-In Receiving History
            </h2>
        </div>
            ...
            <table class="w-full text-left text-xs">
                ...
                <tbody class="divide-y divide-slate-200 dark:divide-slate-800/60" data-auto-animate>
                    ...
                    <tr class="hover:bg-slate-50 dark:hover:bg-dark-800/40 transition-colors">
                        ...
                        <td class="py-3.5 px-4 text-right font-extrabold font-display text-slate-900 dark:text-white text-sm">
                        ...
                        <td class="py-3.5 px-4 text-center">
                            <a href="{{ route('stock-in.show', $stk->id) }}" class="p-1.5 rounded-lg bg-slate-100 dark:bg-dark-800 hover:bg-slate-200 dark:hover:bg-dark-700 text-slate-700 dark:text-slate-300 hover:text-cyan-600 dark:hover:text-cyan-400 text-xs transition-colors border border-slate-300 dark:border-slate-700">
