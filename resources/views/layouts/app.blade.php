...
<body class="min-h-screen antialiased flex flex-col bg-slate-100 text-slate-800 dark:bg-[#090d16] dark:text-slate-100 text-base selection:bg-brand-500 selection:text-white">
    ...
    <header class="h-20 bg-white/95 dark:bg-[#0c1222]/95 backdrop-blur-md border-b border-slate-200 dark:border-slate-800 sticky top-0 z-40 px-5 sm:px-8 flex items-center justify-between shadow-sm">
        ...
        <!-- Left: LOGO (Clicking reveals/slides the Navigation Drawer) -->
        <div class="flex items-center gap-4">
            <button type="button" id="logoToggleBtn" title="Click logo to open navigation menu"
                class="flex items-center gap-3.5 group p-2 -ml-2 rounded-2xl hover:bg-slate-100 dark:hover:bg-dark-800/80 transition-all cursor-pointer focus:outline-none focus:ring-2 focus:ring-cyan-500/50">
                <div class="w-12 h-12 rounded-2xl bg-gradient-to-tr from-brand-600 via-cyan-500 to-blue-600 p-0.5 shadow-lg shadow-cyan-500/20 group-hover:scale-105 transition-transform flex items-center justify-center">
                    <div class="w-full h-full bg-slate-900 rounded-[14px] flex items-center justify-center text-cyan-400 font-black text-2xl font-display">
                        PP
                    </div>
                </div>
                <div class="text-left">
                    <div class="font-display font-black text-slate-900 dark:text-white text-lg tracking-wider flex items-center gap-2">
                        <span>PAOLO PAOLO</span>
                        <span class="text-[10px] font-extrabold bg-cyan-500/15 text-cyan-600 dark:text-cyan-400 border border-cyan-500/30 px-2 py-0.5 rounded-full uppercase tracking-wider">D.A</span>
                    </div>
                    <div class="flex items-center gap-2 text-xs font-semibold text-slate-500 dark:text-slate-400">
                        <span>Matting &amp; Accessories</span>
                        <span class="inline-flex items-center gap-1 text-[11px] text-cyan-600 dark:text-cyan-400 font-bold bg-slate-100 dark:bg-dark-800 px-2 py-0.5 rounded-md border border-slate-300 dark:border-slate-700">
                            <i class="fas fa-bars text-[10px]"></i> Menu
                        </span>
                    </div>
                </div>
            </button>
    ...
    <aside id="navDrawer" class="fixed inset-y-0 left-0 z-50 w-80 sm:w-96 bg-white dark:bg-[#0c1222] border-r border-slate-200 dark:border-slate-800 shadow-2xl transform -translate-x-full transition-transform duration-300 ease-in-out flex flex-col">
        ...
        <div class="p-6 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h3 class="font-display font-black text-slate-900 dark:text-white text-base">Paolo Paolo D.A</h3>
                    <p class="text-xs text-slate-500 dark:text-slate-400">Navigation Menu</p>
                </div>
            </div>
    ...
    <script>
        ...
        // 2. Sliding Navigation Drawer (Logo Click Opens, Module Click Closes)
